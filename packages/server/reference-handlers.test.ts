...
async function postDocExists(
  body: DocExistsTestRequest,
  options: { rootPath?: string; rootPaths?: string[] },
) {
...
async function getDoc(
  path: string,
  options: { base?: string; rootPaths?: string[]; sourceSaveFilePath?: string },
) {
...
describe("handleDocExists", () => {
  test("rejects malformed request bodies", async () => {
    const malformedBodies = [null, { paths: ["valid", 42] }, { paths: ["valid"], base: 123 }];
