  ...
  return (
    <div>
      <button
        ...
        onClick={() => void selectLocation("src/example.ts", 2)}
      >
        Select example
      </button>
      <button
        type="button"
        data-path="src/other.ts"
        onClick={() => void selectLocation("src/other.ts", 2)}
      >
        Select other
      </button>
      <button
        type="button"
        data-path="src/third.ts"
        onClick={() => void selectLocation("src/third.ts", 2)}
      >
        Select third
      </button>
      <output
