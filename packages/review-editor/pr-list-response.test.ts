...
describe('decodePRListResponse', () => {
  ...
  test('rejects entries missing selector fields', () => {
    const missingFieldEntries = [
      { number: 42, title: validPullRequest.title, author: validPullRequest.author, url: validPullRequest.url, state: 'open' },
      { id: validPullRequest.id, title: validPullRequest.title, author: validPullRequest.author, url: validPullRequest.url, state: 'open' },
      { id: validPullRequest.id, number: 42, author: validPullRequest.author, url: validPullRequest.url, state: 'open' },
      { id: validPullRequest.id, number: 42, title: validPullRequest.title, url: validPullRequest.url, state: 'open' },
      { id: validPullRequest.id, number: 42, title: validPullRequest.title, author: validPullRequest.author, state: 'open' },
      { id: validPullRequest.id, number: 42, title: validPullRequest.title, author: validPullRequest.author, url: validPullRequest.url },
    ];
