...
export const ReviewDockTabRenderer: React.FC<IDockviewPanelHeaderProps> = (props) => {
  ...
  return (
    <div className="dv-review-tab" title={title}>
      <span className="dv-review-tab-label">{title}</span>
      <button className="dv-review-tab-close" onClick={handleClose} aria-label="Close">
