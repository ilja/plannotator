...
const OPTION_HINTS: OptionHintMap = {
  ...
  "merge-base":
    "Only what you've added on top of the base branch (picked below). Same as GitHub's PR view.",
    ...
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      <DropdownMenu.Trigger asChild>
        ...
        >
          ...
          {isLoading ? (
            <svg
              className="w-3.5 h-3.5 text-muted-foreground animate-spin flex-shrink-0"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
