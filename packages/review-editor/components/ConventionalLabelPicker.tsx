...
export const CONVENTIONAL_LABELS: LabelDef[] = [
  ...
  },
  {
    ...
    display: "nit",
    tone: "neutral",
    showBlockingToggle: false,
    hint: "Trivial, preference-based",
  },
  {
    label: "question",
    display: "question",
  ...
  // High-signal
  {
    ...
    tone: "danger",
    showBlockingToggle: true,
    hint: "A problem that needs addressing",
  },
  {
    label: "praise",
    display: "praise",
    tone: "success",
    showBlockingToggle: false,
    hint: "Highlight something positive",
  },
  // Soft / meta
  {
    label: "thought",
  ...
  },
  {
    ...
    tone: "warn",
    showBlockingToggle: true,
    hint: "Process task (CI, changelog, etc.)",
  },
];
