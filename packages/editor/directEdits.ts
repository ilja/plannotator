...
export function normalizeEditedMarkdown(
  base: string | null,
...
export function composeFeedbackWithDirectEdits(
...
export function buildSavedFileChangePanelItems(
  changes: SavedFileChangePanelInput[],
): DirectEditPanelItem[] {
