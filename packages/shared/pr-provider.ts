/**
 * Server-only GitHub pull request provider.
 *
 * GitHub implementation may use Node built-ins and must never be imported by
 * browser code. Browser-safe types and URL parsing live in pr-types.ts.
 */
...
/** Fetch per-file viewed state for a pull request. */
...
/** Mark or unmark files as viewed in a pull request. */
...
/** Fetch the stack tree for a stacked pull request. */
