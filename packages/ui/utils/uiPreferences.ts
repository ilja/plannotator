...
export const PLAN_WIDTH_OPTIONS: { id: PlanWidth; label: string; px: number; hint: string }[] = [
  {
    ...
    label: "Compact",
    px: 832,
    hint: "Best for reading. Ideal line length for laptops and focused review.",
  },
  {
    id: "default",
    label: "Default",
    px: 1040,
    hint: "Balanced. More room for code blocks without sacrificing readability.",
  },
  {
    id: "wide",
    label: "Wide",
    px: 1280,
    hint: "For large monitors. Best with diagrams and wide code.",
  },
];
