...
export const BUILT_IN_THEMES: ThemeInfo[] = [
  ...
  },
  {
    ...
    colors: {
      dark: {
        primary: "rgb(193, 154, 107)",
        secondary: "rgb(62, 47, 36)",
        accent: "rgb(139, 90, 43)",
        background: "rgb(30, 22, 16)",
        foreground: "rgb(230, 220, 205)",
      },
      light: {
        primary: "rgb(139, 90, 43)",
        secondary: "rgb(232, 222, 210)",
        accent: "rgb(193, 154, 107)",
        background: "rgb(250, 245, 238)",
        foreground: "rgb(40, 30, 20)",
      },
    },
  },
  {
  ...
  },
  {
    ...
    colors: {
      dark: {
        primary: "rgb(255, 100, 130)",
        secondary: "rgb(40, 30, 35)",
        accent: "#c06ec4",
        background: "rgb(18, 12, 15)",
        foreground: "rgb(240, 230, 235)",
      },
      light: {
        primary: "rgb(200, 50, 80)",
        secondary: "rgb(240, 230, 235)",
        accent: "#ffc1e3",
        background: "rgb(252, 248, 250)",
        foreground: "rgb(25, 15, 20)",
      },
    },
  },
  {
  ...
  },
  {
    ...
    colors: {
      dark: {
        ...
        secondary: "oklch(0.3127 0.039 49.5996)",
        accent: "oklch(0.6 0.12 229.3202)",
        background: "oklch(0.2183 0.0268 49.7085)",
        foreground: "oklch(0.8994 0.0347 70.7236)",
      },
      light: {
        primary: "oklch(0.5553 0.1455 48.9975)",
        secondary: "oklch(0.9139 0.0359 77.3089)",
        accent: "oklch(0.55 0.12 229)",
        background: "oklch(0.9685 0.0187 84.078)",
  ...
  },
  {
    ...
    colors: {
      dark: {
        primary: "rgb(214, 95, 149)",
        secondary: "rgb(50, 50, 60)",
        accent: "rgb(119, 220, 194)",
        background: "rgb(28, 28, 36)",
        foreground: "rgb(230, 230, 240)",
      },
      light: {
        primary: "rgb(214, 95, 149)",
        secondary: "rgb(232, 232, 237)",
        accent: "rgb(119, 220, 194)",
        background: "rgb(247, 247, 250)",
        foreground: "rgb(28, 28, 36)",
      },
    },
  },
  {
