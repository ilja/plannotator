...
const StrictLabelArraySchema = Schema.NullOr(Schema.Array(Schema.Struct({
  label: Schema.String,
...
export function decodeConventionalLabelJsonArray(json: string | null): readonly unknown[] | undefined {
...
export function decodeConventionalLabelEntryFields(value: any): ConventionalLabelEntryFields | undefined {
...
export function decodeStrictConventionalLabels(value: any): StrictConventionalLabelEntry[] | null | undefined {
...
export function decodeStrictConventionalLabelsJson(json: string): StrictConventionalLabelEntry[] | null | undefined {
