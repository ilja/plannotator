...
describe('Settings Obsidian vault discovery', () => {
  test.skipIf(!hasDom)('auto-selects the first decoded vault and renders every valid sibling', async () => {
  ...
  test.skipIf(!hasDom)('uses the existing empty-vault fallback without changing settings for a malformed envelope', async () => {
