...
export const SparklesIcon: React.FC<SparklesIconProps> = ({
  ...
  <svg className={`${className} flex-shrink-0`} viewBox="0 0 128 128" fill="none">
    ...
    <g
      style={
        animated
          ? { animation: "sparkle-idle 2s infinite ease-in-out", animationDelay: "0.35s" }
          : undefined
      }
    >
      <path
    ...
    <g
      style={
        animated
          ? { animation: "sparkle-idle 2s infinite ease-in-out", animationDelay: "0.15s" }
          : undefined
      }
    >
      <path
    ...
    <g
      style={
        animated
          ? { animation: "sparkle-idle 2s infinite ease-in-out", animationDelay: "0.5s" }
          : undefined
      }
    >
      <path
