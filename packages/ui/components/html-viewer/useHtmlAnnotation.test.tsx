...
interface HarnessProps {
  ...
  options?: Partial<Omit<UseHtmlAnnotationOptions, 'iframeRef' | 'annotations' | 'selectedAnnotationId' | 'mode'>>;
}
...
async function dispatchBridgeMessage<Input>(source: MessageEventSource, data: Input): Promise<void> {
  await act(async () => {
...
describe('decodeHtmlBridgeMessage', () => {
  test('decodes a valid selection message', () => {
    expect(decodeHtmlBridgeMessage({
