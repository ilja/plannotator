...
import { getBearSettings, saveBearSettings, normalizeTags, type BearSettings } from "../utils/bear";
import {
  getOctarineSettings,
      ...
      <div className="space-y-2">
        {DEFAULT_DIFF_TYPE_OPTIONS.map((opt) => (
          ...
          >
            ...
            >
              {defaultDiffType === opt.value && <div className="w-2 h-2 rounded-full bg-primary" />}
            </div>
            <div>
    ...
    <>
      <div className="space-y-2">
        <div>
          ...
          <div className="text-xs text-muted-foreground">
            Font family for annotation document text
          </div>
        </div>
        <select
          ...
          style={
            annotationProseFontFamily
              ? { fontFamily: `'${annotationProseFontFamily}', var(--font-sans)` }
              : undefined
          }
        >
          {ANNOTATION_PROSE_FONT_OPTIONS.map((opt) => (
            <option
              key={opt.value}
              value={opt.value}
              style={opt.value ? { fontFamily: `'${opt.value}', var(--font-sans)` } : undefined}
            >
              {opt.label}
            </option>
          ))}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-muted-foreground">
              Base size for annotation document text
            </div>
          </div>
      ...
      <div className="space-y-2">
        <div>
          ...
          <div className="text-xs text-muted-foreground">
            Font family for fenced and inline code in annotation documents
          </div>
        </div>
        <select
          ...
          style={
            annotationCodeFontFamily
              ? { fontFamily: `'${annotationCodeFontFamily}', monospace` }
              : undefined
          }
        >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-muted-foreground">
              Font size for annotation code blocks
            </div>
          </div>
          <div className="text-xs tabular-nums text-muted-foreground min-w-[4ch] text-right">
    ...
    <>
      ...
      <div className="space-y-2">
        <div>
          ...
          <div className="text-xs text-muted-foreground">
            Highlight granularity for inline changes
          </div>
        </div>
        <SegmentedControl
...
const CommentsTab: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`space-y-4 transition-opacity ${conventionalComments ? "" : "opacity-40 pointer-events-none"}`}
      >
        <div className="border-t border-border" />
        ...
        <div className="space-y-3">
          <div>
            ...
            <div className="text-xs text-muted-foreground leading-relaxed mt-1">
              ...
              Labels classify your feedback intent, making it clear whether a comment is a blocking
              issue, a trivial nitpick, or praise.
            </div>
          </div>
          ...
          <div className="rounded-md border border-border bg-muted/30 p-3 space-y-1.5">
            ...
            <div className="font-mono text-[11px] text-foreground/80 leading-relaxed">
              ...
              <span className="text-muted-foreground">(blocking)</span>: This will throw if user is
              null — the guard was removed in the refactor.
            </div>
          </div>
        </div>
...
export const Settings: React.FC<SettingsProps> = ({
  ...
  externalOpen,
  onExternalClose,
  aiProviders = EMPTY_AI_PROVIDERS,
  gitUser,
}) => {
  ...
  useEffect(() => {
    if (showDialog) {
      ...
      setAiProvider(
        resolveAIProviderSelection({ providers: piAIProviders, origin, settings: aiSettings })
          .providerId,
      );
      setFileBrowserSettings(getFileBrowserSettings());
    }
  }, [showDialog, origin, piAIProviders]);
                          ...
                          <div className="mt-3 space-y-3">
                            <div className="space-y-1.5 pl-0.5">
                              ...
                              <input
                                ...
                                onBlur={(e) =>
                                  handleBearChange({ customTags: normalizeTags(e.target.value) })
                                }
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <div className="text-[10px] text-muted-foreground">
                                  Automatically save to Bear when a plan loads, before you approve
                                  or deny
                                </div>
                              </div>
                              <button
                          ...
                          <div className="mt-3 space-y-3">
                            <div className="space-y-1.5 pl-0.5">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleOctarineChange({ workspace: e.target.value })
                                }
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="text-xs font-medium">Auto-save on Plan Arrival</div>
                                <div className="text-[10px] text-muted-foreground">
                                  Automatically save to Octarine when a plan loads, before you
                                  approve or deny
                                </div>
                              </div>
                              <button
                                ...
                                onClick={() =>
                                  handleOctarineChange({ autoSave: !octarine.autoSave })
                                }
                                className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${
