import { annotateSurface, goalSetupSurface } from '../../../../packages/editor/shortcuts';
...
const allSurfaces: ShortcutSurface[] = [annotateSurface, goalSetupSurface, codeReviewSurface];
